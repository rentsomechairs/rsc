import { createQuickPickerOrder, getCategories, getInventory, getOpenOrders, getSettings } from './store.js?v=rental-ux-v40';
...
console.log('QUICK PICKER VERSION:', 'rental-ux-v40');
