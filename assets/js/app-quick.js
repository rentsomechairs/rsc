import { createQuickPickerOrder, getCategories, getInventory, getOpenOrders, getSettings } from './store.js?v=rental-ux-v57';
...
console.log('QUICK PICKER VERSION:', 'rental-ux-v57');
