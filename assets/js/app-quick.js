import { createQuickPickerOrder, getCategories, getInventory, getOpenOrders, getSettings } from './store.js?v=rental-ux-v39';
...
console.log('QUICK PICKER VERSION:', 'rental-ux-v39');
